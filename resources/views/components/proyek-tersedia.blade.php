...
<div class="w-screen h-auto py-24 px-60 flex flex-col justify-center items-center max-md:px-5 ">
    ...
    <div class='w-full flex justify-between items-center mt-10 space-x-4'>
        ...
        <div class="w-1/4 h-14 flex items-center border rounded-lg p-2 bg-white">
            <select class="border-none bg-transparent w-full">
                <option value="#">Semua Sektor CSR</option>
            </select>
        </div>
        ...
        <div class="w-3/4 h-14 flex items-center border rounded-lg bg-white">
            ...
            <input class="w-full h-full border-none stroke-none rounded-lg focus:outline-none" placeholder="Cari Proyek.." type="text">
        </div>
    ...
    <div class="w-full h-full grid grid-cols-4 max-md:grid-cols-2 grid-rows-1 justify-center items-center gap-5 mt-10">
        ...
        <div class="w-full border-2 rounded-md flex justify-start items-center flex-col">
            <img class="w-full h-1/2 rounded-t-md" src="https://asset-2.tstatic.net/jabar/foto/bank/images/bupati-cirebon-imron-rosyadi-saat-rapat.jpg" alt="">
    ...
    <a href="" class="w-72 py-3 border-2 rounded-md flex justify-center items-center mt-10 hover:bg-slate-200 transition">Lihat semua laporan</a>
</div>