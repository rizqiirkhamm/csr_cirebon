                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-[28px] font-semibold leading-[44px] tracking-[-0.02em] text-left font-inter">Buat Laporan Baru</h2>
                        </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg w-[1240px] p-6 space-y-6 border border-gray-200">
                            <form id="laporan-form" action="{{ route('dashboard.laporan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                                ...
                                <div class="w-full h-[73px] space-y-2">
                                    ...
                                    <input type="text" name="judul_laporan" id="judul_laporan" class="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-[0px_1px_2px_0px_#1018280D]" placeholder="Masukan nama laporan CSR" required>
                                </div>
                                ...
                                <div class="flex space-x-5">
                                    ...
                                    <div class="w-[586px] space-y-2">
                                        ...
                                        <input type="number" name="realisasi" id="realisasi" class="w-full h-12 px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-[0px_1px_2px_0px_#1018280D]" placeholder="Rp 0" required>
                                    </div>
                                </div>
                                ...
                                <div class="w-full space-y-2">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" rows="4" class="w-full h-[100px] px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-[0px_1px_2px_0px_#1018280D]" placeholder="Deskripsi"></textarea>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div id="image-container" class="mt-2 flex flex-wrap gap-[11.18px]">
                                        <div id="upload-box" class="w-[300px] h-[183.29px] border border-gray-300 border-dashed rounded-[8.94px] flex items-center justify-center cursor-pointer overflow-hidden relative">
